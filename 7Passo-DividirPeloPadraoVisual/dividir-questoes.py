...
def encontrar_faixa_azul(imagem, cor_alvo, tolerancia=15, altura_faixa=7): # ATUALIZADO: altura alterada para 7
    """
    ...
    while y < altura - altura_faixa:
        ...
        if faixa_encontrada:
            ...
            posicao_corte = y - 35  # ATUALIZADO: Cortar 35 pixels antes do padrão
            if posicao_corte < 0:  # Evitar posições negativas
                posicao_corte = 0
                
            posicoes_corte.append(posicao_corte)
            print(f"Padrão visual encontrado começando em y={y}, cortando em y={posicao_corte}")
...
def dividir_imagem_por_faixas(caminho_imagem, pasta_saida, cor_alvo):
    ...
    for i, posicao_corte in enumerate(posicoes_corte):
        ...
        posicao_anterior = posicao_corte + 7  # ATUALIZADO: Pula a faixa de 7 pixels
...
if __name__ == "__main__":
    ...
    # ATUALIZADO: Definido diretamente para RGB (0, 0, 0)
    cor_do_padrao = (0, 0, 0) 
